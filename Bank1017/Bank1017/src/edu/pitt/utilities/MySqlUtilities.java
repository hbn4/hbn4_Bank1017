...
public class MySqlUtilities implements DbUtilities {
    ...
    private String dbName = "hbn4_bank1017"; // default database name
    private String dbUserName = "hbn4"; // login name for the database server
    private String dbPassword = "3778271"; // password for the database server
